...
"<!-- built-in implicit transforms @SVN_VERSION=1186M@ -->\n"
...
"\n"
"	<!-- For some reason, lhs doesn't have a discipline object, so use the first probe's... -->\n"
"	<admst:if test=\"[$mysource/nature=rhs/probe[1]/discipline/potential]\">\n"
"	  <admst:value-of select=\"$mysource/branch/nnode/name\"/>\n"
"	  <admst:value-of select=\"$mysource/branch/pnode/name\"/>\n"
"	  <admst:new datatype=\"node\" inputs=\"module,'%s%s_branch'\">\n"
"		<admst:variable name=\"branchnode\" path=\".\"/>\n"
"		<admst:new datatype=\"attribute\" inputs=\"'info'\">\n"
"		  <admst:push into=\"../attribute\" select=\".\"/>\n"
"		</admst:new>\n"
"		<admst:new datatype=\"attribute\" inputs=\"'nature'\">\n"
"		  <admst:push into=\"../attribute\" select=\".\"/>\n"
"		</admst:new>\n"
"		<admst:value-to select=\"attribute[name='info']/value\" path=\"name\"/>\n"
"		<admst:value-to select=\"attribute[name='nature']/value\" path=\"../rhs/probe/discipline/potential\"/>\n"
"		<admst:reverse select=\"/module/node\"/>\n"
"		<admst:push into=\"/module/node\" select=\".\" onduplicate=\"ignore\"/>\n"
"		<admst:reverse select=\"/module/node\"/>\n"
"	  </admst:new>\n"
"	</admst:if>\n"
"\n"
...
"      </admst:new>\n"
"\n"
"	  <!-- Need a 0V voltage source in the I<+I case for sensing input current. -->\n"
"	  <admst:if test=\"[$mysource/nature=discipline/flow and nature=discipline/flow]\">\n"
"		<admst:value-of select=\"branch/nnode/name\"/>\n"
"		<admst:value-of select=\"branch/pnode/name\"/>\n"
"		<admst:new datatype=\"node\" inputs=\"module,'%s%s_sense'\">\n"
"		  <admst:variable name=\"branchnode\" path=\".\"/>\n"
"		  <admst:new datatype=\"attribute\" inputs=\"'info'\">\n"
"			<admst:push into=\"../attribute\" select=\".\"/>\n"
"		  </admst:new>\n"
...
"		  </admst:new>\n"
"		  <admst:value-to select=\"attribute[name='info']/value\" path=\"name\"/>\n"
"		  <admst:value-to select=\"attribute[name='nature']/value\" path=\"discipline/potential\"/>\n"
"		  <admst:reverse select=\"/module/node\"/>\n"
"		  <admst:push into=\"/module/node\" select=\".\" onduplicate=\"ignore\"/>\n"
"		  <admst:reverse select=\"/module/node\"/>\n"
"		</admst:new>\n"
"		<admst:new datatype=\"jacobian\" inputs=\"module,branch/pnode,$branchnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new datatype=\"jacobian\" inputs=\"module,$branchnode,branch/pnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new test=\"branch/nnode[grounded='no']\" datatype=\"jacobian\" inputs=\"module,branch/nnode,$branchnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new test=\"branch/nnode[grounded='no']\" datatype=\"jacobian\" inputs=\"module,$branchnode,branch/nnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new datatype=\"jacobian\" inputs=\"module,$branchnode,$branchnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"	  </admst:if>\n"
"\n"
"	  <!-- Create a voltage source for voltage contributions. -->\n"
"	  <admst:if test=\"[$mysource/nature=discipline/potential]\">\n"
"		<admst:new datatype=\"jacobian\" inputs=\"module,$mysource/branch/pnode,$branchnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new datatype=\"jacobian\" inputs=\"module,$branchnode,$mysource/branch/pnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new test=\"$mysource/branch/nnode[grounded='no']\" datatype=\"jacobian\" inputs=\"module,$mysource/branch/nnode,$branchnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new test=\"$mysource/branch/nnode[grounded='no']\" datatype=\"jacobian\" inputs=\"module,$branchnode,$mysource/branch/nnode\">\n"
"		  <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
"		</admst:new>\n"
"		<admst:new datatype=\"jacobian\" inputs=\"module,branch/pnode,$branchnode\">\n"
"          <admst:push into=\"/@jacobian\" select=\".\" onduplicate=\"ignore\"/>\n"
